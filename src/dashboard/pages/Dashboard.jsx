        ...
        <DashboardSummaryCard
          icon={
            <svg width="37" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M16.6597 20.6723C19.7338 20.6723 22.3613 21.1382 22.3613 22.999C22.3613 24.8598 19.7513 25.339 16.6597 25.339C13.5847 25.339 10.958 24.8773 10.958 23.0157C10.958 21.154 13.5672 20.6723 16.6597 20.6723Z" stroke="#1C1D22" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path fill-rule="evenodd" clip-rule="evenodd" d="M16.6599 18.0165C14.6415 18.0165 13.0049 16.3807 13.0049 14.3623C13.0049 12.344 14.6415 10.7082 16.6599 10.7082C18.6774 10.7082 20.314 12.344 20.314 14.3623C20.3215 16.3732 18.6965 18.009 16.6857 18.0165H16.6599Z" stroke="#1C1D22" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M22.4023 17.068C23.7365 16.8805 24.764 15.7355 24.7665 14.3497C24.7665 12.9838 23.7707 11.8505 22.4648 11.6363" stroke="#1C1D22" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M24.1631 20.2768C25.4556 20.4693 26.3581 20.9227 26.3581 21.856C26.3581 22.4985 25.9331 22.9152 25.2464 23.176" stroke="#1C1D22" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          } />
        ...
        <DashboardSummaryCard
          icon={
            <svg width="37" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M22.0945 25.9167H15.138C12.5827 25.9167 10.6223 24.9937 11.1791 21.279L11.8275 16.2447C12.1708 14.3911 13.3531 13.6817 14.3904 13.6817H22.8725C23.9251 13.6817 25.0388 14.4445 25.4354 16.2447L26.0838 21.279C26.5567 24.5742 24.6498 25.9167 22.0945 25.9167Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M22.209 13.4987C22.209 11.5103 20.5971 9.89835 18.6087 9.89835V9.89835C17.6512 9.89429 16.7315 10.2718 16.0531 10.9474C15.3746 11.6231 14.9932 12.5411 14.9932 13.4987V13.4987" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M21.0801 17.2515H21.042" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M16.2208 17.2515H16.1826" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          } />
      </div>
          ...
          <div className='lg:grid lg:grid-cols-2 lg:gap-5 md:flex md:flex-col sm:flex sm:flex-col'>
            ...
            <div className='flex flex-col justify-between gap-5'>
              <DashboardSummaryCard
                ...
                icon={
                  <svg width="37" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.669922" width="36" height="36" rx="8" fill="white" fill-opacity="0.16" />
                ...
                icon={
                  <svg width="37" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g clip-path="url(#clip0_181_4413)">
                      <path d="M25.3363 26.3333C25.7965 26.3333 26.1696 25.9602 26.1696 25.5C26.1696 25.0398 25.7965 24.6667 25.3363 24.6667C24.876 24.6667 24.5029 25.0398 24.5029 25.5C24.5029 25.9602 24.876 26.3333 25.3363 26.3333Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M16.1702 26.3333C16.6305 26.3333 17.0036 25.9602 17.0036 25.5C17.0036 25.0398 16.6305 24.6667 16.1702 24.6667C15.71 24.6667 15.3369 25.0398 15.3369 25.5C15.3369 25.9602 15.71 26.3333 16.1702 26.3333Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M9.50293 8.83333H12.8363L15.0696 19.9917C15.1458 20.3753 15.3545 20.72 15.6592 20.9652C15.9639 21.2105 16.3452 21.3408 16.7363 21.3333H24.8363C25.2273 21.3408 25.6086 21.2105 25.9133 20.9652C26.218 20.72 26.4267 20.3753 26.5029 19.9917L27.8363 13H13.6696" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                    <defs>
